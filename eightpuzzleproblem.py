...
#         initial_state (_type_): Takes the intial state of the board as a parameter
#     """    
#     def dfs_limited(state, depth_limit):
...
#         if depth_limit == 0: # checks to see if the depth limit is 0
#             return None
#         for neighbor in state.get_neighbors(): # gets the next neighbor
#             result = dfs_limited(neighbor, depth_limit - 1) #recurses next state with a lower depth limit
#             if result:
#                 return result
#         return None
